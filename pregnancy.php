...
<!-- <div class="content">
        <h3>Pregnancy</h3>
        <p>Congratulations, and welcome to your pregnancy!</p>
        <p>Looking for a week-by-week guide to pregnancy? You're in luck! From what to expect each week to how to prepare for labor and beyond, here's the info you need.</p>
    </div> -->
<!-- <div>
  <h3>Pregnancy</h3>
  <p>Congratulations, and welcome to your pregnancy!</p>
  ...
  <div class="preg-img"><img src="images/rsz_1pregnancy.jpg" class="preg-img" alt="">
